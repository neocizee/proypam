...
public class dtoArboles {
    ...
    public dtoArboles(int ele, int nombre, int modulo, String fecha, int id_gps, int id_asociad, String observacion, int plantilla, int altura_ini, int altura_fin, int lado, int id_bbdd, String obs_data, float circunsf, float diametro, float numeracion_aproximada, boolean rare_elements, String desc_rare_elements, boolean clavel_del_aire, float ancho_vereda, boolean vereda_damage, boolean vereda_levantada, String actualizacion, int calle_id, int altura_id, int especie_arbol_id, int vereda_id, int estado_gen_id, int espacio_id)
    {
        this.ele = ele;
        this.nombre = nombre;
        this.modulo = modulo;
